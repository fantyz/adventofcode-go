...
func Day25() {
	...
	fmt.Println("Encryption key:", Transform(ReverseEngineerLoopSize(day25InputCardPublicKey, 7), day25InputDoorPublicKey))
}
...
func ReverseEngineerLoopSize(pubKey int, subject int) int {
	v := 1
	for i := 1; ; i++ {
		v = (v * subject) % 20201227
		if v == pubKey {
