...
func main() {
	...
	fmt.Println("Spreadsheet Checksum:", SpreadsheetChecksum(puzzle))
	fmt.Println("Evenly Divisible Value sum:", EvenlyDivisibleValueSum(puzzle))
}

func SpreadsheetChecksum(in string) int {
	sum := 0
...
func EvenlyDivisibleValueSum(in string) int {
	sum := 0
...
const puzzle = `104	240	147	246	123	175	372	71	116	230	260	118	202	270	277	292
